...
//SOUNDS
var mySound = new Audio("jump.mp3");
...
var results,life,score,timeElapsed,totalTimer,speedX,speedY,standingOnLog,player,
...
{	
	...
	function getPowerType() {
		...
		function actPower(){ //
			...
			if ( typeOfPower1==false ){
				life++;
				console.log("life added");
			}
			else{
				score= score + 100;
				console.log("score added by power");
			}
...
function updateGame()
{
	...
	if  (playerMidPtX <= (power.x + 50)
		&& power.x <= (playerMidPtX + 50)
		&& playerMidPtY <= (power.y + 50)
		&& power.y <= (playerMidPtY + 50))
		{
			actPower();
			createPower();	
		}
...
function updateDraw()
{
	...
	//draw splat
	ctx.drawImage(splat,0,0,50,50,splat.x,splat.y,50,50);
	//DRAW POWERS
